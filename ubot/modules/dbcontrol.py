...
@bot.on_message(filters.command("delprem"))
@ubot.on_message(
    anjay("delprem") & filters.me)
...
@bot.on_message(filters.command("getprem"))
@ubot.on_message(anjay("getprem") & filters.me)
...
@ubot.on_message(anjay("setexp") & filters.me)
